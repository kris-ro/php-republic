...
<div class="app-content-header">
  ...
  <div class="container-fluid">
    <!--begin::Row-->
    <div class="row">
      <div class="col-sm-6"><h3 class="mb-0"> Admin &raquo; Todo &raquo; Update</h3></div>
    </div>
    <!--end::Row-->
  </div>
  <!--end::Container-->
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="card card-primary card-outline mb-4">
          <!--begin::Header-->
          <div class="card-header"><div class="card-title">Update Todo</div></div>
          <!--end::Header-->
          <!--begin::Form-->
          <form action="/admin/todos/update/<?php echo self::view('item/todo_id') ?>" method="POST" enctype="multipart/form-data">
            <?php echo self::getFormToken('updatetodo') // self is instance of KrisRo\PhpRepublic\Template ?>
            <!--begin::Body-->
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control <?php echo self::view('errors/users_id') ? 'border-danger text-danger' : '' ?>" name="users_id" id="users_id-id" value="<?php echo Request::isPost() ? Request::post('users_id') : (self::view('item/users_id') ?? '') ?>">
