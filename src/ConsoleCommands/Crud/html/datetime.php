...
<?php echo $data['indent'] ?>  <input type="datetime-local" class="form-control <?php echo '<?php echo self::view(\'errors/' . $data['name'] . '\') ? \'border-danger text-danger\' : \'\' ?>' ?>" name="<?php echo $data['name'] ?>" id="<?php echo $data['name'] ?>-id" value="<?php echo '<?php echo Request::isPost() ? Request::post(\'' . $data['name'] . '\') : (self::view(\'item/' . $data['name'] . '\') ?? \'\') ?>' ?>">
